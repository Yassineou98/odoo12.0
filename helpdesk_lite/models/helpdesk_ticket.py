...
class HelpdeskTicket(models.Model):
    ...
    priority = fields.Selection(AVAILABLE_PRIORITIES, 'Priority', index=True, default='3', track_visibility='onchange', readonly=True)
    ...
    def _preprocess_write_changes(self, changes):
        ...
        Route = self.env['helpdesk_lite.stage.route']
        ...
        if 'motif_id' in changes:
            raise exceptions.ValidationError(_(
                'It is not allowed to change ticket motif'))
        return vals
